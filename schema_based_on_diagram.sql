...
ALTER TABLE
  invoices
ADD
  CONSTRAINT fk_medical_history    KEY (medical_history_id) REFERENCES medical_histories(id);

ALTER TABLE
  invoice_items
ADD
  CONSTRAINT fk_invoice_id FOREIGN KEY (invoices_id) REFERENCES invoices(id);
